...
/* TM64181_VM_ACCESS_INLINE
 *
 * Use the canonical static-inline guest-memory accessors. The previous
 * external declarations changed the linkage of ppu_memory.h inline
 * definitions under clang-cl and emitted duplicate vm_read/vm_write symbols
 * when cellSpurs.c was pulled from the runtime static library.
 */
